...
class No {
    ...
    // construtor
    public No(Characters characters) {
...
class ArvoreBinaria {
    ...
    public void inserir(Characters characters) throws Exception {
        raiz = inserir(characters, raiz);
    }

    private No inserir(Characters characters, No i) throws Exception {
        if (i == null) {
            i = new No(characters);
        } else if (characters.getName().compareTo(i.characters.getName()) < 0) {
            i.esquerda = inserir(characters, i.esquerda);
        } else if (characters.getName().compareTo(i.characters.getName()) > 0) {
            i.direita = inserir(characters, i.direita);
        } else {
            throw new Exception("Erro: Personagem Existente na Arvore");
        }
    ...
    private boolean pesquisar(String characterName, No i) {
        ...
        } else if (characterName.compareTo(i.characters.getName()) < 0) {
            MyIO.print("esq ");
...
public class Binaria {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < enterNumber; i++) {
            ...
            arvoreBinaria.inserir(characters[i]);
        }
        ...
        for (int i = 0; i < totalPersonagensPesquisados; i++) {
            ...
            if (arvoreBinaria.pesquisar(nomesPersonagensPesquisados[i])) {
                MyIO.println("SIM");
            } else {
